    ...
    <div class="nsw-container">
      <div class="nsw-header__wrapper">
        ...
        <div class="nsw-header__left">
          <button type="button" class={`nsw-header-btn nsw-header-btn--menu ${ hideMobileMenu ? 'nsw-header-btn--hidden' : '' }`}>
        ...
        <div class="nsw-header__right">
          <button type="button" class={`nsw-header-btn nsw-header-btn--search js-open-search ${ hideSearch ? 'nsw-header-btn--hidden' : '' }`} aria-expanded="false"
            aria-controls="header-search">
            <i class={`material-icons nsw-material-icons nsw-header-btn__icon`} focusable="false" aria-hidden="true">search</i>
            <span class="nsw-header-btn__sub" aria-hidden={hideSearch ? 'true' : 'false'}><span class="sr-only">Show</span> Search</span>
          </button>
        </div>
      </div>
