      ...
      <div className="nsw-container">
        <div className="nsw-header__wrapper">
          <div className="nsw-header__center">
            <a href={logoUrl} className="nsw-header__logo-link">
          ...
          <div className="nsw-header__left">
            <button type="button" className={`nsw-header-btn nsw-header-btn--menu ${hideMobileMenu ? 'nsw-header-btn--hidden' : ''}`}>
              <i className="material-icons nsw-material-icons nsw-header-btn__icon" focusable="false" aria-hidden="true">menu</i>
            </button>
          </div>
          <div className="nsw-header__right">
            <button
              type="button"
              className={`nsw-header-btn nsw-header-btn--search js-open-search ${hideSearch ? 'nsw-header-btn--hidden' : ''}`}
              aria-expanded="false"
              aria-controls="header-search"
            >
              <i className="material-icons nsw-material-icons nsw-header-btn__icon" focusable="false" aria-hidden="true">search</i>
        ...
        <div className="nsw-search">
          <div id="header-search" className="nsw-search__area js-search-area" hidden>
            <form role="search">
              <label htmlFor="nsw-search__input" className="sr-only">Search site for:</label>
              <input
                autoComplete="off"
              ...
              <button className="nsw-search__submit" type="submit" aria-label="search">
                <i className="material-icons nsw-material-icons nsw-search__search-icon" focusable="false" aria-hidden="true">search</i>
              </button>
            </form>
            <button className="nsw-search__close-btn js-close-search" aria-expanded="true" aria-controls="header-search" type="button">
              <i className="material-icons nsw-material-icons nsw-search__close-icon" focusable="false" aria-hidden="true">close</i>
